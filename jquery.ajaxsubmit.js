(function($){
	...
	$.fn.ajaxSubmit = function(arg){
		...
		$this.submit(function(event){
			...
			var successCallable = typeof arg.success == 'function',
				beforeSendCallable = typeof arg.beforeSend == 'function';
			if(arg.setSelector && $this.find(arg.setSelector).length){
				...
				options.success = function(result){
					...
					if(successCallable){
						if(!arg.once || i == length-1) arg.success.call($this, t);
					}
					i++;
				};
				...
				options.success = function(result){
					if(successCallable) arg.success.call($this, result);
				};
				$.ajax(options);
			}
		});
